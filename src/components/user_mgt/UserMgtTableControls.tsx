      ...
      <div className="flex gap-3 mb-3">
        ...
        <div className="relative">
          <input
            ...
            className="border border-[#00000080] rounded-[5px] px-12 py-2 pr-5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors min-w-[300px]"
          />
          <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
            ...
            >
              <path
                d="M19 19L13 13M15 8C15 11.866 11.866 15 8 15C4.13401 15 1 11.866 1 8C1 4.13401 1 8 1C11.866 1 15 4.13401 15 8Z"
                stroke="#9CA3AF"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
