...
export const getSingleOrderUser = async (
  ...
  return await apiCall(API_ENDPOINTS.ADMIN.OrderShowUser(id), "GET", undefined, token);
};
...
export const getSingleOrder = async (
  ...
  return await apiCall(API_ENDPOINTS.ADMIN.OrderShow(id), "GET", undefined, token);
};